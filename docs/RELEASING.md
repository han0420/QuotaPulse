...
Before publishing, install the DMG on a clean standard macOS account and verify launch, location consent, Codex-only, Claude-only, dual-provider display, login-at-startup, and uninstall behavior.
